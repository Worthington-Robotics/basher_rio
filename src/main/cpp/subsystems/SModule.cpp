...
namespace robot
{
    ...
    frc::SwerveModuleState SModule::getState()
    {
        ...
        return frc::SwerveModuleState{units::feet_per_second_t{drive->GetSelectedSensorVelocity() / 2048 * 4 * M_PI * 10 / 39.37}, frc::Rotation2d{units::degree_t{angle->GetSelectedSensorPosition() / TICKS_PER_DEGREE / (64 / 5)}}};
    }
